...
export default async function handler(req, res) {
  ...
  try {
    const { prompt, tier, lang } = req.body;
    ...
    // Hindi language instruction appended when lang=hi
    const hindiInstruction = lang === 'hi'
      ? '\n\nभाषा निर्देश: यह पूरी रीडिंग हिंदी में लिखें (देवनागरी लिपि)। सरल, गर्म हिंदी उपयोग करें। ग्रह नाम, मंत्र, देवता और योग के नाम संस्कृत/हिंदी में ही रखें। Sign-off भी हिंदी में: कल्याणम् अस्तु। विजयी भव। — Your Angel'
      : '';
...
- End with exactly this sign-off on its own line: Kalyanam Astu. Vijayi Bhav. — Your Angel${hindiInstruction}`;
